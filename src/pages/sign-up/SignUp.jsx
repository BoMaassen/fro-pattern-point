...
function SignUp(){
    ...
    return <main>
        <section className="sign-up-section">
            ...
            <form onSubmit={handleSubmit(handleSignUpSubmit)} className="login-form">
                <div className="upper-part">
                    <img src={profilePicture} alt="Profiel foto"/>
                    <div className="fields">
                        <Textarea className="text-field-red" textareaId="biography" labelName="Bio" register={register} errors={errors}/>
                        ...
                        <Input className="text-field-red" inputId="email" name="email" labelName="Email"
                               validationRules={{
                                   required: {
                                       value: true,
                        ...
                        <Input className="text-field-red" inputId="haker" name="role" labelName="Haker" validationRules={{
                        ...
                        <Input className="text-field-red" inputId="patroonmaker" name="role" labelName="Patroonmaker" validationRules={{
